...
public class Const {
	...
	public   static  final  int PRINT_NEXT=1002;
	public   static  final  int PRINT_ERR=1003;
	public   static  final  int COFIRM_CARD=1004;

	public static class EvenBUSType {
		/**
		 * 前置扫码
		 */
		public static final int TRANS_SUCCSE = 3001;
		public static final int TRANS_ERR = 3002;
		public static final int READ_CARD_SUCCSE = 3003;
		public static final int READ_CARD_ERR = 3004;
		public static final int REFUND_REVER_SUCCSE = 3005;
		public static final int APP_PARAMS_CHANGE = 3006;
	}
