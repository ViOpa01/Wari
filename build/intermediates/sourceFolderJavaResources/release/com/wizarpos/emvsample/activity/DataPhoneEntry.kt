...
class DataPhoneEntry : AppCompatActivity(), View.OnClickListener {
    ...
    private fun payWithWallet() {
        ...
        var pfm :Pfm? = Pfm(PfmStateGenerator(this,tid).generateState(), PfmJournalGenerator(null, appState.nibssData.configData, false, dataItem.amount, emvCard, "Data", dataItem.type, "").generateJournal())
        ...
        PinAlertUtils.getPin(this, view) {
            ...
            GlobalScope.launch(Dispatchers.Main){
                ...
                try {
                    ...
                    Log.d("payDetails now  >>>>>", Gson().toJson(payDetails))
