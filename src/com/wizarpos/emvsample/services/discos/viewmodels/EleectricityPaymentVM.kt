        ...
        fun payElectricBill(activity: Activity, amount: String, wallet: String, userName: String, requestType: String, meterType: String, meterNumber: String, channel: String, phone: String, productCode: String, pin: String, paymentMetod: String, electricMeterType: String, password: String, customerName: String, clientReference: String, terminalId: String,pfm:Pfm) {
            ...
            when (electricMeterType){
                ...
                VasServices.EKO_ELECTRICITY_POSTPAID, VasServices.EKO_ELECTRICITY_PREPAID ->{
                    details= EkoModel.EkoPayDetails(amount = (amount.toInt()).toString(),channel = channel,phone = phone,pin = pin,password =password ,type = meterType,clientReference = clientReference,meter = meterNumber,accountType = meterType,terminal_id = wallet,user_id = userName,pfm = pfm,paymentMethod = paymentMetod)
                ...
                VasServices.IKEJA_ELECTRICITY_POSTPAID ->{
                    details= IkejaModel.IkejaPayDetailsPostPaid(amount = (amount.toInt()).toString(),terminal_id = wallet,terminal = wallet,channel = channel,phone = phone,pin = pin,password =password ,type =type ,clientReference = clientReference,service_type =service_type ,service =meterType,user_id = userName,account = meterNumber,pfm = pfm,paymentMethod=paymentMetod)
                ...
                VasServices.IKEJA_ELECTRICITY_PREPAID ->{
                    details= IkejaModel.IkejaPayDetailsPrepaid(amount = (amount.toInt()).toString(),terminal_id = wallet,terminal = terminalId,channel = channel,phone = phone,pin = pin,password =password ,type =type ,clientReference = clientReference,service_type =service_type ,service =meterType,user_id = userName,meter = meterNumber,pfm = pfm,paymentMethod = paymentMetod)
