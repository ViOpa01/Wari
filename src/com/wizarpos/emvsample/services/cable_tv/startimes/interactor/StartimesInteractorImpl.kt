...
//
            pfm = com.itex.richard.payviceconnect.model.Pfm(PfmStateGenerator(context,tid).generateState(), PfmJournalGenerator(null, FuncActivity.appState.nibssData.configData, false, amount.toString(), emvCard, "Startimes", bouquet, "").generateJournal())
        ...
        pfm = com.itex.richard.payviceconnect.model.Pfm(PfmStateGenerator(context,tid).generateState(), PfmJournalGenerator(FuncActivity.appState.trans.transactionResult, FuncActivity.appState.nibssData.configData, false, amount.toString(), emvCard, "Startimes", bouquet, "").generateJournal())
