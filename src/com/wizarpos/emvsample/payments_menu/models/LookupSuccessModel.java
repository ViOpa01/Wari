...
//    public LookupSuccessModel(int status, int convenienceFee, int amountSettled, int amountCharged, String message, String beneficiaryName, String account, String vendorBankCode, String description, String productCode) {
    public LookupSuccessModel(int status, int convenienceFee, int amountSettled, int amountCharged, String message, String beneficiaryName, String account, String vendorBankCode, String description, String productCode) {
        this.status = status;
