...
public class DatabaseOpenHelper extends SQLiteOpenHelper
{
	...
	public final static String TABLE_TRANS_RESULT     = "trans_result";
	
	private final static String DATABASE_NAME    = "emvsample.db";
    private final static int    DATABASE_VERSION = 2;

	public final static String CREATE_TRANSACTION_RESULT_SQL =
			"Create table if not exists " + TABLE_TRANS_RESULT + " ( _id"              + " integer primary key autoincrement," +
					" amount"              + " varchar(20)," +
					" status"            + " varchar(11)," +
					" rrn"		   + " varchar(20)," +
					" result"            + " varchar(900)," +
	...
	public final static String CREATE_Config =
			"Create table if not exists " + "config" + " ( _id"            + " integer primary key autoincrement," +
					" config"              + " text)";
	...
	public final static String TABLE_TRANS_DETAIL2 = "transwolf";
	public final static String CREATE_TRANS_DETAIL_SQL2 =
			"Create table if not exists " + TABLE_TRANS_DETAIL2 + " ( _id"              + " integer primary key autoincrement," +
					" trace"            + " integer," +
					" pan"              + " varchar(19)," +
					" entryMode"        + " char(1)," +
					" expiry"           + " char(4)," +
	...
	public void createTable(SQLiteDatabase db, String tableName)
	{
		...
		else if(tableName.equals(TABLE_TRANS_DETAIL2))
		{
			db.execSQL(DatabaseOpenHelper.CREATE_TRANS_DETAIL_SQL2);
		}
		else if(tableName.equals(TABLE_TRANS_ADVICE))
		{
			db.execSQL(DatabaseOpenHelper.CREATE_TRANS_ADVICE_SQL);
		}
		else if(tableName.equals("config")){
			db.execSQL(DatabaseOpenHelper.CREATE_Config);
		}
		else if(tableName.equals(TABLE_TRANS_RESULT)){
			db.execSQL(DatabaseOpenHelper.CREATE_TRANSACTION_RESULT_SQL);
		}
	}
    ...
    public void onCreate(SQLiteDatabase db)
    {
		...
		db.execSQL(CREATE_TRANS_DETAIL_SQL2);
    	...
    	db.execSQL(CREATE_TRANSACTION_RESULT_SQL);
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion)
    {
		...
		db.execSQL("drop table if exists " + TABLE_TRANS_RESULT);
		db.execSQL("drop table if exists " + TABLE_TRANS_DETAIL2);
