...
//						  ConnectionData connectionData = new ConnectionData(TID, "196.6.103.73", 5043, true);
						  ...
						  Log.d(" Vas Connection data >>>", new Gson().toJson(connectionData));

						  Log.d(" Vas ConfigData  data >>>", new Gson().toJson(configData));
						  Log.d(" Vas KeyHolder data >>>", new Gson().toJson(keyHolder));


						  Log.d(" Vas EmvCard data >>>", new Gson().toJson(emvCard));

						  Log.d("Vas TransactionData  data >>>", new Gson().toJson(transactionType));
						  Log.d("Vas InputData data >>>", new Gson().toJson(inputData));
