...
data class AirtimeRequestDetails(@Expose val terminal_id : String, @Expose val user_id: String, @Expose val amount: String, @Expose val phone : String, @Expose val service : String, @Expose val pin : String, @Expose val password : String,@Expose val pfm : Pfm)