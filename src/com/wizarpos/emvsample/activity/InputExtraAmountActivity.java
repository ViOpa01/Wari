...
public class InputExtraAmountActivity extends FuncActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
		...
		if(appState.refund || appState.balanceEnc){
		...
		textAmount.setOnKeyListener(new View.OnKeyListener()
		{
			...
			public boolean onKey(View v, int keyCode, KeyEvent event)
			{
				if(event.getAction() == KeyEvent.ACTION_DOWN)
					InputExtraAmountActivity.this.onKeyDown(keyCode, event);
				return true;
			}
		});
	...
	protected void onEnter()
	{
		...
		if(appState.nibssData == null){
            Toast.makeText(InputExtraAmountActivity.this,"Configurtion error",Toast.LENGTH_LONG).show();
		...
		public void onClick(View v)
		{
			...
			case R.id.btn_digit_enter:
				if(amount > 0 && amount<= 999999999)
				{
					...
					appState.trans.setOthersAmount(amount);
